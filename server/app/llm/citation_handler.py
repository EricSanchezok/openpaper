...
class CitationHandler:
    ...
    def format_citations(citations: Sequence["CitationPayload"]) -> str:
        ...
        for citation in citations:
            if "document_id" in citation:
                # Multi-paper format: @cite[key|document_id]
                cite_marker = f"@cite[{citation['key']}|{citation['document_id']}]"
            else:
    ...
    def convert_response_citation_to_paper_citation(
        ...
        for resp_citation in response_citations:
            ...
            if resp_citation.document_id is not None:
                citation["document_id"] = resp_citation.document_id
            citations.append(citation)
        return {"citations": citations}
    ...
    def resolve_compacted_citations(
        ...
        for citation in citations:
            ...
            best_match = CitationHandler._find_best_match(
                reference, document_id, citation_index
            )
            ...
            if best_match:
                ...
                if document_id is not None:
                    resolved_citation["document_id"] = document_id
    ...
    def _find_best_match(
        ...
        candidates = [
            ...
            if snippet.document_id == document_id
        ]
