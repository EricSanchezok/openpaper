...
def upgrade() -> None:
    op.add_column(
        "papers", sa.Column("parser_backend", sa.String(), nullable=True), schema="scholens"
    )
    op.add_column(
        "papers", sa.Column("parser_quality", sa.String(), nullable=True), schema="scholens"
    )
    op.add_column(
        "papers", sa.Column("parser_version", sa.String(), nullable=True), schema="scholens"
    )
    op.add_column(
        "papers",
