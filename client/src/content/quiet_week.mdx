...
That's the product story of the week: Scholens getting quieter, so your research can be louder.
...
None of this changes what Scholens *is*.
...
We made the permissions story more predictable (which specific actions a collaborator can take and what an owner controls) and improved how the product behaves when you're collaborating: fewer weird states, clearer affordances, and better behavior around project limits.
...
Scholens is at its best when it's a tight loop:
