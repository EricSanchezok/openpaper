export const metadata = {
    title: "Introducing Scholens v0.1",
    description: "Scholens is a research application designed to transform how researchers interact with scholarly literature. This is the first version of the app.",
    date: "05-17-2025",
    image: "https://assets.khoj.dev/waves_blue_abstract.png"
}

Today we're launching Scholens v0.1, a research application designed to transform how researchers interact with scholarly literature. We're building Scholens to address the challenges researchers face when working with academic papers, from organization to comprehension to collaboration. This is a tool that aims to be your AI-native paper-reading research assistant, helping you navigate the complexities of academic literature with ease.

![Scholens v0.1](https://assets.khoj.dev/openpaper_still_v01.png)

## A Central Hub for Your Research

As researchers, you may often find ourselves juggling dozens of PDFs across multiple folders, struggling to locate that perfect citation when we need it most. Scholens solves this by providing a single home for all your research papers.
...
Taking notes while reading papers is essential, but traditional methods often separate the notes from the source material. Scholens brings these together with an integrated annotation system.
...
AI can be a powerful research assistant, but only if you can verify its claims. Scholens's chat functionality is built with transparency at its core.
...
Research doesn't happen in isolation. Scholens includes a Paper Finder tool that connects you to a public database of academic papers, helping you discover related research that might inform your work.
...
Scholens is designed with this philosophy in mind. Our tools aim to enhance your natural research workflow, providing assistance when needed while keeping you firmly in control of the research process. Delightful and effective experiences that integrate AI should use them as guides and nudges, rather than encouraging them to replace novel thought.

## Join the Scholens Community

Scholens v0.1 is just the beginning. We're committed to building tools that respect the research process while making it more efficient and enjoyable. We invite you to try Scholens, share your feedback, and help us shape the future of AI-assisted research.
