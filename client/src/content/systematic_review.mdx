export const metadata = {
    ...
    description: "A practical guide to using AI tools to streamline a systematic review — from organizing papers to extracting structured evidence and writing with confidence.",
    date: "02-14-2026",
...
Scholens is built around eliminating these transitions. Your papers, your notes, your AI conversations, your structured data — they all live in one place, linked together. Here's how that plays out across a full systematic review.
...
## Phase 2: Locate and Import Relevant Research

This is where most reviews hit their first wall. Search each database required by your protocol, document the exact queries and filters you used, and export the results in a format you can audit later. Sources such as PubMed, Web of Science, Scopus, Google Scholar, and field-specific indexes have different coverage, so a reproducible review normally uses more than one.

Once you have screened the titles and abstracts, download the eligible PDFs or export your Zotero collection and import them into Scholens. Scholens begins at this boundary: it keeps the papers you selected, their extracted content, your notes, and later analysis together. Search strategy and inclusion decisions remain explicit rather than being hidden behind an AI-generated ranking.
...
This is your screening phase. For each paper, Scholens automatically generates:
- A brief summary
