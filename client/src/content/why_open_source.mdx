...
The "open" in Scholens isn't just branding. Our entire codebase is [available on GitHub](https://github.com/EricSanchezok/scholens), and we believe this is how research tools should be built. Here's why.
