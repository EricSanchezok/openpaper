export const metadata = {
    title: "Why is Scholens Open Source?",
...
The "open" in Scholens isn't just branding. Our entire codebase is [available on GitHub](https://github.com/EricSanchezok/openpaper), and we believe this is how research tools should be built. Here's why.
...
When you use Scholens to chat with a PDF, you're trusting our citation protocol to accurately ground AI responses in the source material. You're trusting that when we say "this response comes from page 7," it actually does. With closed-source software, that trust is a leap of faith. With open source, it's verifiable. You can read our [citation grounding implementation](https://github.com/EricSanchezok/openpaper) and confirm it works the way we claim.
...
We're building Scholens because we think researchers deserve better tools. Open source is how we ensure those tools remain worthy of trust.
