export const metadata = {
    title: "About",
    description: "About Scholens. We help researchers manage their knowledge more effectively and understand research papers 10x better.",
    date: "08-05-2025",
}
...
Welcome to Scholens, a platform designed to help researchers and academics easily access and understand research papers. Our mission is to **make research more accessible, helping researchers spend less time managing papers and more time on their research**.
...
2. A central place where I could easily read & understand papers.
...
So we decided to build Scholens, a platform that combines the best of AI and open-source principles to help researchers like myself manage their papers more effectively.

While the code is [open source](https://github.com/EricSanchezok/openpaper), we decided not to optimize heavily on the self-hosting experience this time around.
...
We want Scholens to be accessible to everyone.

Okay, so what are we building? You can check out the [manifesto](https://scholens.sanchezcloud.net/blog/manifesto), but the best way to see is to [try it yourself](https://scholens.sanchezcloud.net) :).
