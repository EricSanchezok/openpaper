...
While the code is [open source](https://github.com/EricSanchezok/scholens), we decided not to optimize heavily on the self-hosting experience this time around.
