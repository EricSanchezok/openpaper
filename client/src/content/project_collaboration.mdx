export const metadata = {
    ...
    description: "Invite collaborators, set roles, and co-build chats + artifacts (with citations) inside Scholens Projects.",
    date: "01-10-2026",
...
That’s why **Projects** in Scholens aren’t just a way to bundle papers—they’re a shared workspace you can invite others into. If you haven’t tried Projects yet, start with the announcement post: [Projects: Your Research Hub](/blog/projects).
...
<iframe
  ...
  title="Scholens Projects walkthrough"
  frameBorder="0"
...
If your collaborator doesn’t already have an Scholens account, they’ll be prompted to create one first—then they can accept the Project invitation.
...
This is the first step toward richer collaboration in Scholens. The goal is simple: **better ways for humans to work with humans**, without sacrificing citation integrity.
