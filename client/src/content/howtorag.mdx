...
The same internal DeepSeek backend now handles tool orchestration and final
answers. OpenPaper exposes only standard and deep reasoning levels; model names
